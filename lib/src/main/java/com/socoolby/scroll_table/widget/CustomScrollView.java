package com.socoolby.scroll_table.widget;
...
public class CustomScrollView extends FrameLayout {
    ...
    static final String TAG="CustomScrollView";
        ...
        switch (action & MotionEvent.ACTION_MASK) {  
            case MotionEvent.ACTION_MOVE: {  
                ...
                */  
                ...
                System.out.println("onInternal x:"+mLastMotionX+"  y:"+mLastMotionY);
//                Toast.makeText(getContext(),"x:"+mLastMotionX+"  y:"+mLastMotionY).show();
                break;
            }  
        ...
        switch (action & MotionEvent.ACTION_MASK) {  
            case MotionEvent.ACTION_DOWN: {  
                ...
                if (!mScroller.isFinished()) {
                    if(aboutAnimationListnere!=null)
                        aboutAnimationListnere.abortAnimation();
...
//                System.out.println("onTouch x:"+mLastMotionX+"  y:"+mLastMotionY);
                break;  
            case MotionEvent.ACTION_UP:   
                if (mIsBeingDragged) {  
                    if(mFlingEnabled){  
...
//        Func.Log(TAG," smoothScrollBy x:"+dx+" y:"+dy);
        if (getChildCount() == 0) {  
            // Nothing to do.  
            return;  
        }  
...
//        Func.Log(TAG," somoothScrollTo x:"+x+" y:"+y);
...
//        Func.Log(TAG,"onSizeChanged w:"+w+" h:"+h+" oldw:"+oldh+" oldh:"+oldh);
        View currentFocused = findFocus();  
     ...
     */
    private  FlingListener flingListener=null;
...
//        Func.Log(TAG,"fling velocityX:"+velocityX+" velocityY:"+velocityY);
        if (getChildCount() > 0) {
            if (flingListener != null) {
                flingListener.flingListener(velocityX,velocityY);
            }
...
//            {
//                scrollTo(getScrollX()+velocityX,getScrollY()+velocityY);
//            }
...
//            }  
     ...
     */
//    public void abortAnimat()
//    {
//        abortAnimat();
//    }
    public void setAbortAnimateStop()
    {
        mScroller.abortAnimation();
    }
    private  AbortAnimationListener aboutAnimationListnere;
    public interface  AbortAnimationListener
    {
        public void abortAnimation();
    }
    public void setAbortAnimationListner(AbortAnimationListener aboutAnimationListner)
    {
        this.aboutAnimationListnere=aboutAnimationListner;
    }
